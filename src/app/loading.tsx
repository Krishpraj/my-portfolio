...
export default function Loading() {
  ...
  if (value < 100) {
    return (
      <div className="relative h-screen bg-black cursor-crosshair overflow-hidden">
        ...
        <div className="absolute  right-0 bottom-0 mr-8 mb-8">
          <NumberTicker
            delay={1}
            value={100}
            className="whitespace-pre-wrap text-[400px] font-medium tracking-tighter text-white"
          />
        </div>
      </div>
    );
